...
public class TestDataIterator implements DataSetIterator {
    ...
    public TestDataIterator(String filename, int miniBatchSize, int exampleLength, double splitRatio, PriceCategory category, NormalizeType normalizeType) {
