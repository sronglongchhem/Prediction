...
public class EarlyStopping {
    ...
    public static void main (String[] args) throws IOException {
        String fileTrain = new ClassPathResource("Binance_BTCUSDT_d.csv").getFile().getAbsolutePath();
        String fileTest = new ClassPathResource("Binance_BTCUSDT_TEST.csv").getFile().getAbsolutePath();
...
//         iterator = new CryptoDataSetIterator(file, symbol, batchSize, exampleLength, splitRatio, category);
     ...
     //   List<Pair<INDArray, INDArray>> test = iterator.getTestDataSet();
        ...
        EarlyStoppingConfiguration esConf = new EarlyStoppingConfiguration.Builder()
                .epochTerminationConditions(new MaxEpochsTerminationCondition(200), new ScoreImprovementEpochTerminationCondition(8)) //Max of 50 epochs
