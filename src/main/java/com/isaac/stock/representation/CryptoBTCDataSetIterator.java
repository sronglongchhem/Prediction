 ...
 * @author ZHANG HAO
 */
public class CryptoBTCDataSetIterator implements DataSetIterator {
...
//    PriceCategory.LOW, 2, PriceCategory.HIGH, 3,PriceCategory.VOLUME,4 ,PriceCategory.BTC,5
    private final Map<PriceCategory, Integer> featureMapIndex1 = ImmutableMap.of(
    ...
    public static Map<PriceCategory, Integer> featureMapIndex;
    static {
        featureMapIndex = new HashMap<>();
        featureMapIndex.put(PriceCategory.OPEN, 0);
        featureMapIndex.put(PriceCategory.CLOSE, 1);
        featureMapIndex.put(PriceCategory.LOW, 2);
        featureMapIndex.put(PriceCategory.HIGH,3);
        featureMapIndex.put(PriceCategory.VOLUME,4);
    ...
    public CryptoBTCDataSetIterator(String filename, String symbol, int miniBatchSize, int exampleLength, double splitRatio, PriceCategory category) {
